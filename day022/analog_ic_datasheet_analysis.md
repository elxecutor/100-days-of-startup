...
Action:
- Use INA219 if you need a compact battery fuel gauge sense front-end at 5.0 V. Otherwise select a part with better noise or speed for your band.
