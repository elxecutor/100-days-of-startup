Analog IC Datasheet Analysis - Day 027
Part: AD8232
Focus: ECG front-end
...
- Application target: ECG front-end
...
Action:
- Use AD8232 if you need a compact ECG front-end front-end at 3.3 V. Otherwise select a part with better noise or speed for your band.
