Analog IC Datasheet Analysis — AD8226 instrumentation amplifier

Checklist (what to scan first):
- **Overview:** instrumentation amp family and target application (bridge sensors).
- **Absolute max / supply range:** check single-supply operation and rail headroom.
- **Electrical specs:** gain error, CMRR, input bias, noise.

Example — AD8226 quick analysis:
- **Overview:** compact INA for bridge sensors with high CMRR.
- **Key specs:** high CMRR, programmable gain, optimized for low-level signals.

Actionable recommendation:
- Use AD8226 for Wheatstone bridges; confirm drift and offset with temperature sweeps.

Day 003 focus: AD8226 — verify gain error and input bias for your bridge.
