...
Action:
- Use INA282 if you need a compact buck current monitor front-end at 3.3 V. Otherwise select a part with better noise or speed for your band.
