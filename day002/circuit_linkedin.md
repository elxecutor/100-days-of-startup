LinkedIn Post (audio preamp)

Built an audio-grade preamp for EdgeNode using OPA2134: low distortion and low noise for analog audio capture. Simulated and measured to ensure clean midband response.

Short caption for LinkedIn (1 sentence):
Audio preamp for EdgeNode — OPA2134-based, low THD capture. DM for measurements and netlist.

Day 002 variant: Audio preamp using OPA2134 — cleaner midband for analog audio capture.
